		...
		<div class="col-md-9">
			...
			<div id="owl-partners-3" class="owl-carousel owl-theme">
				...
				<?php foreach ( $partner_gallery as $image ): ?>
					<div class="item">
						<?php if ( isset( $image[ 'partner_url' ] ) && $image[ 'partner_url' ] != '' ): ?>
						<a href="<?php echo esc_url( $image[ 'partner_url' ] ); ?>" target="_blank">
								<img src="<?php echo $image[ 'partner_image' ] != '' ? esc_url( $image[ 'partner_image' ][ 'url' ] ) : ''; ?>" class="img-responsive" alt="<?php echo esc_attr( $image[ 'partner_alt' ] ); ?>">
							</a>
							<?php else: ?>
								<img src="<?php echo $image[ 'partner_image' ] != '' ? esc_url( $image[ 'partner_image' ][ 'url' ] ) : ''; ?>" class="img-responsive" alt="<?php echo esc_attr( $image[ 'partner_alt' ] ); ?>">

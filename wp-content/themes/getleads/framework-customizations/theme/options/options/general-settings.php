		...
		'options'	 => array(
			'general-box' => array(
				...
				'options'	 => array(
					...
					'favicon'			 => array(
						'label'	 => esc_html__( 'Favicon', 'appscraft' ),
						'type'	 => 'html',
						'html'	 => sprintf( "%s %s %s", __( 'Favicon moved to default customizer.  go to  <a href="', 'premix' ), admin_url( '/customize.php' ), __( '">Cutomizer -> </a> Site Identity -> Site icon', 'appscraft' ) ),
					),
					'loader'			 => array(
						'type'			 => 'switch',

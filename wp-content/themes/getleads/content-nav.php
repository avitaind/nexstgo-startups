                        ...
                        <ul class="nav navbar-nav">
                            ...
                            if (defined('FW')) {
                                ...
                                foreach ($menu_btn as $btn):
                                    ?>
                                    <?php if ($btn) { ?>
                                        <li><a href="<?php echo esc_url($btn['btn_link']); ?>" class="btn-nav nav-btn header-cta-btn btn-<?php getleads_theme_button_class($btn['btn_style']); ?>"><?php echo wp_kses_post($btn['btn_label']); ?></a></li>
                                    <?php } ?>
                                    <?php
                                endforeach;
                            }

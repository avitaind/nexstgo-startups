...
//        fw_print($bg_color);
		...
		. ".getleads-footer{background:$bg_color;Color:$txt_color}.woocommerce-info a{color: $main_color;}.woocommerce-info::before {color: $main_color;}"
		...
		. "$custom_css";
		wp_enqueue_style(
		'custom-style', GETLEADS_CSS . '/custom_script.css'
		);
